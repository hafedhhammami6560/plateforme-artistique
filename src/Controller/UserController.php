...
final class UserController extends AbstractController
{
    ...
    ): Response
    {
        ...
        $totalAdmins = count(array_filter($users, fn($u) => in_array('ROLE_ADMIN', $u->getRoles())));
        $totalVerified = count(array_filter($users, fn($u) => method_exists($u, 'isVerified') ? $u->isVerified() : false));
